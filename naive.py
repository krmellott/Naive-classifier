...
#Taking the antilog of the total probability results in a 0 even out to 64 decimal places. I was able
#to get one number, but it was raised to the power of negative 326 so I left all probabilities in
#log form.

#The highest accuracy I could get was 46% and I don't know why. I spent several hours attempting to
#troubleshoot and could not increase to the required 60%. My program assigns negative sentiment
#75% of the time and I couldn't figure out why or fix it.
